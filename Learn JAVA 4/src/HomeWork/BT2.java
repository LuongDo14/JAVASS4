            ...
            switch (choise) {
                ...
                case 4:
                    ...
                    if (row == col) {
                        ...
                        System.out.println("Đây không phải mảng 2 chiều vuông");
                    }
                    System.out.printf("Tổng chéo chính và chéo phụ là: %d", sumCheoChinh);
                ...
                case 5:
                    ...
                    System.out.printf("Giá trị max %d - Giá trị min %d ", max,min);
                    System.out.println();
                    break;
                case 6:
                    //"6. Sắp xếp mảng tăng dần theo cột");
